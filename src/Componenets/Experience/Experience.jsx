...
<a href="#Nav"><IoIosArrowDropupCircle className="size-[50px] relative left-[320px] md:left-[650px] lg:left-[1400px] top-[860px] md:top-[600px] lg:top-[500px]  text-white"></IoIosArrowDropupCircle></a>
          <div id="Experience" className="bg-[#4b4f52] h-[850px] md:h-[600px] lg:h-[500px]  ">
