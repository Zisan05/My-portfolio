...
<p className="text-[18px] font-normal text-white text-center">Here you can use all this information to contract with me. <br /> just contract me and  i will ensure that i<br /> will respons of your request .</p>
  ...
  <div data-aos="fade-right" className="flex flex-col md:flex-col lg:flex-row gap-[25px]  mt-[30px] justify-center ml-[30px] md:ml-[170px] lg:ml-0">
    <a href="mailto:mdzisanislam69@gmail.com" target="_blank"  className="bg-[#4b4f52] w-[320px] md:w-[400px] lg:w-[400px]  py-[15px] flex flex-row-reverse justify-around items-center">
    ...
    <a href="https://wa.me/8801790866932" target="_blank" className="bg-[#4b4f52] w-[200px] md:w-[200px] lg:w-[200px]  py-[15px] flex flex-row-reverse justify-around items-center ml-[60px] md:ml-[100px] lg:ml-0">
  ...
  <a href="https://m.me/100092237885166" target="_blank"  className="bg-[#4b4f52] w-[200px] md:w-[200px] lg:w-[200px] py-[15px] flex flex-row-reverse justify-around items-center ml-[60px] md:ml-[100px] lg:ml-0">
  ...
  <a href="https://github.com/Zisan05" target="_blank" className="bg-[#4b4f52] w-[200px] md:w-[200px] lg:w-[200px]  py-[15px] flex flex-row-reverse justify-around items-center ml-[60px] md:ml-[100px] lg:ml-0">
